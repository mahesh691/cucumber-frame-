...
public class LoginTestMultipledata {
	...
	@When("^Login application by enter \"([^\"]*)\" and \"([^\"]*)\" and click on signin$")
	public void Login_application_by_enter_and_and_click_on_signin(String username, String password)  {
	...
	public void User_should_be_able_to_successfull_login_to_the_application_and_close_the_application(String username) throws IOException  {
		...
		try {
			...
			FileUtils.copyFile(screenshot, new File("E:\\JavaProgrammes\\Cucumber1\\Screenshot\\failed"+username+".png"));
